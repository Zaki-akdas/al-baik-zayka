      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        ...
        <Reveal className="mt-6 flex justify-center">
          <a
            ...
            className="inline-flex items-center gap-2 rounded-full border border-maroon/25 bg-white px-4 py-2 text-sm font-bold text-maroon transition-all hover:-translate-y-0.5 hover:border-maroon/40 hover:shadow-md hover:shadow-maroon/10"
          >
